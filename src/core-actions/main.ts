...
//                 url: `https://www.realtimetrains.co.uk/search/detailed/gb-nr:EUS${dest ? `/to/gb-nr:${dest}` : ''}`
//             })
//             res = await fetch(url)
...
//                 url =
//                     `https://www.realtimetrains.co.uk/search/detailed/gb-nr:EUS${dest ? `/to/gb-nr:${dest}` : ''}`
//                 res = await fetch(url)
